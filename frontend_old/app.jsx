        ...
        <div className="goals-section">
          ...
          <div className="goals-summary">
            <div className="summary-card">
              ...
              <p className="value">{Math.round(goals.summary.completion_percentage)}%</p>
              <p className="sublabel">{goals.summary.completed_goals} of {goals.summary.total_goals} completed</p>
            </div>
          </div>
...
function App() {
  const auth = useAuth();
  const [isProfileSetup, setIsProfileSetup] = useState(localStorage.getItem('profileSetup') === 'true');

  const handleLogin = () => {
    const profileSetup = localStorage.getItem('profileSetup') === 'true';
  ...
  if (!isProfileSetup) {
    return <ProfileSetup token={auth.token} userId={auth.userId} onComplete={handleProfileComplete} />;
  }

  return (
    <div className="app">
      <Dashboard token={auth.token} userId={auth.userId} />
      <button 
